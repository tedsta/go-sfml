...
func (self *Vector2u) SetX(x uint) {
	self.Cref.x = C.uint(x)
}

func (self *Vector2u) SetY(y uint) {
	self.Cref.y = C.uint(y)
}
...
func (self *Vector2i) SetX(x int) {
	self.Cref.x = C.int(x)
}

func (self *Vector2i) SetY(y int) {
	self.Cref.y = C.int(y)
}
...
func (self Vector2f) X() float32 {
	return float32(self.Cref.x)
}

func (self Vector2f) Y() float32 {
	return float32(self.Cref.y)
}

func (self *Vector2f) SetX(x float32) {
	self.Cref.x = C.float(x)
}

func (self *Vector2f) SetY(y float32) {
	self.Cref.y = C.float(y)
}
